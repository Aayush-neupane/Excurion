...
export const mockNotifications: AppNotification[] = [
  ...
  },
  {
    id: 'n-3',
    kind: 'chat',
    title: 'New message from Peter',
    body: 'Peter Parker: “For problem 3, do we use the product rule first?”',
    read: false,
  ...
  },
  {
    ...
    body: 'Steve Rogers is experiencing a weak connection in your class.',
    read: true,
  ...
  },
  {
    ...
    body: 'Clint Barton joined “Physics — Newton’s Laws Lab”.',
    read: true,
    createdAt: daysAgo(2),
  },
  {
